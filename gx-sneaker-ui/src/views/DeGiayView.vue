...
const API = "http://localhost:8080/api/de-giay"
  ...
  <div class="container">
    ...
    <div class="card form">
      ...
      <div class="grid">
        ...
        <div>
          <input v-model="form.ma" placeholder="Mã đế giày" />
          <small class="error-text">{{ errors.ma }}</small>
        </div>

        <div>
          <input v-model="form.ten" placeholder="Tên đế giày" />
